...
MODULE_DESCRIPTION("This is the most useless Kernel module ever, insmod it and your Kernel will halt ;)");
...
static int __init halt_module_init(void){
	...
	//Now this is the correct time for an emergency restart ;)
	kernel_halt();
	//You could also call kernel_power_halt()
